...
This page maps completed GitHub Project work to the product and engineering outcomes now present in the gamification plugin. It is intentionally outcome-oriented: when an issue checklist and the final implementation differ, this page describes the implementation that actually exists now.
